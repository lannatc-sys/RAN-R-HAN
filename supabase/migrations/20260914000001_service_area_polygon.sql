...
--
-- หยิบมาจาก branch feat/service-area-map เฉพาะไฟล์นี้ไฟล์เดียว
-- เปลี่ยนเลขจาก 20260913000001 เป็น 20260914000001 เพราะเลขเดิมชนกับ
-- 20260913000001_secure_payment_slips_storage_policy.sql ที่อยู่บน main แล้ว
--
