...
async function runDatabaseSetup() {
  ...
  try {
    ...
    await runMigrationFile(client, migrationsDir, '20260914000007_rider_polygon_enforcement.sql', '1.25', 'Rider geofence enforcement switched to the polygon-aware predicate applied.');
