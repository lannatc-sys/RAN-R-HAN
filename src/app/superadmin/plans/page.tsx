  ...
  const plans = [
    {
      ...
      features: [
        'รับที่ร้าน / สั่งกลับบ้าน (Takeaway)',
    ...
    },
    {
      ...
      features: [
        'ทานที่ร้าน (Dine-in) + สั่งกลับบ้าน',
        'ร้านจัดส่งเอง (Delivery พร้อม GPS)',
    ...
    },
    {
      ...
      features: [
        'ครบทุกช่องทาง (Dine-in, Takeaway, Delivery)',
